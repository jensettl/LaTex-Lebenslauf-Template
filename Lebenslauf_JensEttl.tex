...
\begin{rSection}{Projekte}
    ...
    \begin{adjustwidth}{0.5cm}{}
        ...
        \justifying{Evaluation sensorbasierter Mehrwertdienste auf dem Hochschulcampus mit dem Ziel, verschiedene Anwendungsfälle zu bewerten und ihre Potenziale zu identifizieren.
        Abschließend wurde ein Anwendungsfall basierend auf früheren Entwicklungen auf dem Campus umgesetzt. 
        Meine Aufgabe war es unter anderem, die Aufgaben aus den Gesprächen mit dem Kunden auszuarbeiten und an das Team zu delegieren.}
